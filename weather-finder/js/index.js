...
function changeBackground(weatherCode) {
  switch(weatherCode) {
    case "Clear": $("body").css("background-image", "url(http://i.imgur.com/2w55Bf8.png)"); break;
    case "Thunderstorm": $("body").css("background-image", "url(http://i.imgur.com/pa0iWOP.png)"); break;
    case "Clouds": $("body").css("background-image", "url(http://i.imgur.com/h7evV8f.png)"); break;
    case "Rain": $("body").css("background-image", "url(http://i.imgur.com/yXzgXLA.png)"); break;
